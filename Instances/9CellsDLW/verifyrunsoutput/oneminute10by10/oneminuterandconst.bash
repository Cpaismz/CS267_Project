...
python $TORUN --input-instance-folder=$DDIR --ignitions --nsims=10 --output-grid --weather-file --plot --combine --ROS-Start-Threshold=1e-3 --Mean-Burnout-Periods=2 --ROS-CV=0.13 --output-folder=outdir --weather=constant --seed=1134 --PeriodLen=1
