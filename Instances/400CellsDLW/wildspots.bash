...
DDIR="$BASEDIR/Instances/400CellsDLW/wildspots"
TORUN="$BASEDIR/Jan2018dlw/AlphaVersion/SimJan2018.py"

python $TORUN --input-instance-folder=$DDIR --ignitions --nsims=10 --output-grid --weather-file --ROS-Start-Threshold=1e-3 --Mean-Burnout-Periods=2 --ROS-CV=0.13 --output-folder=outdir --weather=date-based --seed=1134 --spotting-parameter-data-file-name=SpotParms.json
