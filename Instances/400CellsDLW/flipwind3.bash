...
python $TORUN --input-instance-folder=$DDIR --ignitions --nsims=10 --output-grid --weather-file --ROS-Start-Threshold=1e-3 --Mean-Burnout-Periods=3 --ROS-CV=0.13 --output-folder=outdir --weather=date-based --seed=1134
