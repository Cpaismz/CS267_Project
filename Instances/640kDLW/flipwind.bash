...
python $TORUN --input-instance-folder=$DDIR --ignitions --nsims=1  --weather-file --plot --combine --ROS-Start-Threshold=1e-3 --Mean-Burnout-Periods=2 --ROS-CV=0.13 --output-folder=outdir --weather=date-based --seed=1134 --max-fire-periods=100
###--verbose --output-grid
