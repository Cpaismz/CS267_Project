# ReadData.py is not a descriptive name. This has code and structures
#    to interface with FBP.
# Based on  FBP-LINE-newest.py
# Original Author (FBP-LINE-newest.py): David L. Woodruff, January 2017
# Modified by: Cristobal Pais, October 2017 
...
def CalculateOne(df,coef_ptr,ncel,verbose=False):
	...
	for index, row in df.iterrows():
		...
		'''
		Modification October 2017: return all 4 objects instead of only main...
		'''
				
		# New return: All 4 objects needed for RAZ (mainstruct) and ROS (rest)
		return mainstruct, headstruct, flankstruct, backstruct
