...
class TestExamples(unittest.TestCase):
    ...
    def test_9CellsDet1k60min(self):
        ...
        # use None and the argument for flags such as ignitions and weather-file
        adict = {"input-instance-folder": ifolder,\
                 ...
                 "weather": "constant",
                 "sim-years": "1",
                 "ROS-Start-Threshold": "1e-3",
                 "Mean-Burnout-Periods": "0",
