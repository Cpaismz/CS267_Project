...
class Forest {
    public:
        ...
        Forest(int _id, std::string _location, std::vector<double> _coord, int _nCells, double _area, double _col, int _age, double _perimeter, std::unordered_map<std::string, int> & fTypes); // TODO: change types
