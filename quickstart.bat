...
SET DDIR=%C:\Users\dlm\Dropbox\1_Woodruff_FireSimulator\Instances\9CellsHom\%
...
python %TDIR%SimJan2018.py --input-instance-folder=%DDIR% --ignitions --nsims=1 --output-grid --weather-file --plot --combine --ROS-Start-Threshold=1e-3 --Mean-Burnout-Periods=2 --output-folder=outdir
